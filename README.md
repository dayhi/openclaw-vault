...
> **第三方 Skill 适配指引**：如果你想让正在使用的第三方 Skill 也受 Vault 保护，或者你是 Skill 开发者想让 Skill 原生适配 Vault，请参阅 [适配指引（中文）](docs/GUIDE.zh-CN.md) | [Adaptation Guide (English)](docs/GUIDE.md)。
